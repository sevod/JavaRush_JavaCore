            ...
            while (!isInterrupted()) {
                try {
                    if (reader.ready()) {
                        ...
                        System.out.println("Thread " + this.getName() + " : " + readStringCount); //
                    }
                } catch (Exception e) {
                    System.out.println("Thread " + this.getName() + "Exception"); //
                    return;
                   //e.printStackTrace();
                }
            }
            System.out.println("Thread " + this.getName() + " : завершил работу : " + readStringCount); //
        }
